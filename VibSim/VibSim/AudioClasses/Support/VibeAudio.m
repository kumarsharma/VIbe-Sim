...
//    *scrollHistory = (float*)calloc(kVibeAudioPlotMaxHistoryBufferLength,floatByteSize);
  }

  //
  if( !*isChanging ){
    float rms = [VibeAudio RMS:buffer length:bufferSize];
